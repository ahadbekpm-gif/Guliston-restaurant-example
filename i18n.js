const translations = {
  uz: {
    hero: {
      ...
      title: "Uchrashuv Best — Gulistondagi premium milliy va yevropa taomlari",
    ...
    menu: {
      ...
      sushi: "Sushi",
      steak: "Steyk",
      first_dishes: "Birinchi taomlar",
      second_dishes: "Ikkinchi taomlar",
      fast_food: "Fast-fud",
      breakfast: "Nonushta",
      salads: "Salatlar",
      tea: "Choy",
  ...
  ru: {
    hero: {
      ...
      title: "Uchrashuv Best — премиальные национальные и европейские блюда в Гулистане",
  ...
  en: {
    hero: {
      ...
      title: "Uchrashuv Best — Premium National & European Cuisine in Gulistan",
